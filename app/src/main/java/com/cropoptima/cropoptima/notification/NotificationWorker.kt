package com.cropoptima.cropoptima.notification
...
abstract class NotificationWorker(ctx: Context, params: WorkerParameters) : Worker(ctx, params) {
...
//        val channelName = inputData.getString(NOTIFICATION_CHANNEL_ID)
